    ...
    <div className="min-h-screen overflow-x-hidden bg-[var(--chalk)] lg:grid lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
      <aside className="relative flex min-h-[330px] flex-col justify-between overflow-hidden bg-[#0a0a0a] px-5 py-7 text-white sm:px-8 sm:py-10 lg:min-h-screen lg:px-14 lg:py-16">
        ...
        <div className="relative my-12 max-w-[500px] lg:my-0">
          <div className="eyebrow mb-5 text-[var(--se)]">Verify email</div>
      ...
      <section className="flex min-h-[calc(100vh-330px)] items-center justify-center px-4 py-8 sm:px-6 lg:min-h-screen lg:px-12 lg:py-16">
        <div className="w-full max-w-[460px]">
          <div className="mb-7">
            <div className="eyebrow mb-2 text-[var(--se)]">Email code</div>
            <h2 className="font-serif text-3xl leading-tight sm:text-[38px]">Enter your 6-digit code.</h2>
            <p className="mt-3 text-[var(--muted)]">
              We sent a verification code to <span className="font-semibold text-[var(--ink)]">{email || "your email"}</span>.
            </p>
          </div>
          ...
          <form className="rounded-xl border border-[var(--border)] bg-white p-5 shadow-[var(--shadow-xs)] sm:p-7" noValidate onSubmit={handleSubmit}>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              <Btn className="w-full" variant="ghost" onClick={onBack}>
                Back
              </Btn>
              <Btn
                className="w-full"
            ...
            <div className="mt-5 flex items-center gap-2 rounded-lg bg-[var(--chalk)] px-3 py-2 text-xs text-[var(--muted)]">
              <Icon name="shield" size={14} className="text-[var(--se)]" />
